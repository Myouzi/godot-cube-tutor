...
- **决策后更新(2026-09-25)**:A-1 **已交付**——项目所有者裁决 GPL-3.0,`LICENSE` 已就位(README「许可」节同步);A-2 **进行中**——issue 文本已代拟(`docs/upstream-license-issue.md`),待项目所有者用 GitHub 账号发送,无果则以社区通用公式集重录替换。A-7(facelet 导入通道——成本中高)仍未排期。
